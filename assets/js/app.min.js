...
! function (t, e) {
      ...
      fn: function (t) {
         ...
         if (!e.modifiersData[n]._skip) {
            for (var o = i.mainAxis, s = void 0 === o || o, r = i.altAxis, a = void 0 === r || r, l = i.fallbackPlacements, c = i.padding, d = i.boundary, u = i.rootBoundary, h = i.altBoundary, p = i.flipVariations, f = void 0 === p || p, m = i.allowedAutoPlacements, g = e.options.placement, v = ft(g), y = l || (v !== g && f ? function (t) {
               ...
               var P = Dt(z),
                  D = [];
               if (s && D.push(L[E] <= 0), a && D.push(L[z] <= 0, L[P] <= 0), D.every((function (t) {
                     return t
                  }))) {
                  S = C, T = !1;
                  break
   ...
   var Ce = "tooltip",
      ...
      Pe = function (t) {
         ...
         return s.enable = function () {
            ...
            if (null !== t) return "object" == typeof e && h(e) ? (e.jquery && (e = e[0]), void(this.config.html ? e.parentNode !== t && (t.innerHTML = "", t.appendChild(e)) : t.textContent = e.textContent)) : void(this.config.html ? (this.config.sanitize && (e = xe(e, this.config.allowList, this.config.sanitizeFn)), t.innerHTML = e) : t.textContent = e)
         }, s.getTitle = function () {
            ...
            return Object.keys(e).forEach((function (t) {
               ...
               show: t.delay,
               hide: t.delay
            }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), f(Ce, t, this.constructor.DefaultType), t.sanitize && (t.template = xe(t.template, t.allowList, t.sanitizeFn)), t
   ...
   _((function () {
      ...
      if (t) {
         var e = t.fn[De];
         t.fn[De] = We.jQueryInterface, t.fn[De].Constructor = We, t.fn[De].noConflict = function () {
...
function (t) {
   t.fn.tilt = function (e) {
      var i = function () {
         ...
         d = function () {
            if (this.transforms = c.call(this), this.reset) return this.reset = !1, t(this).css("transform", "perspective(" + this.settings.perspective + "px) rotateX(0deg) rotateY(0deg)"), void(this.settings.glare && (this.glareElement.css("transform", "rotate(180deg) translate(-50%, -50%)"), this.glareElement.css("opacity", "0")));
